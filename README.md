...
5. **Mobile hamburger menu** — nav links hide below 920px, leaving only the brand on phones/tablets. Add a hamburger that opens the section links (match the editorial aesthetic: mono labels, forest/cream, no generic drawer).
6. **Content ideas parked for later** — Strava embed/live stats, photo touches from the bookshelf/journal scans, a writing/notes section if he starts publishing.
